  ...
  return (
    <Container mt="3rem" mb="3rem">
      ...
      <Timeline active={14} bulletSize={38} lineWidth={3} mt="3rem" mb="3rem">
        ...
        >
          <Text color="" size="sm">
            Ar ko nodarbojas uzņēmums, kurā biji praksē? Cik darbinieku tajā ir?
            Ko vēl interesantu vari pastāstīt? Ja biji 2 uzņēmumos, piemini
            abus.
          </Text>
        </Timeline.Item>
        <Timeline.Item
        ...
        >
          <Text color="" size="sm">
            Apraksti, lūdzu, cik veiksmīga bija sadarbība ar prakses vadītāju un
            kolēģiem. Ar kādiem izaicinājumiem un prieka brīžiem saskāries tieši
            komunikācijā?
          </Text>
        </Timeline.Item>
        <Timeline.Item
